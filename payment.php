      ...
      <form class="row g-3">
        <div id="Form1">
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="inputCardNumber" class="f-input" id="inputAddress" placeholder="XXXX XXXXX XXXXX" required>
          </div>

          <div class="row">
            <div class="col">
              <label class="f-label">EXP. DATE*</label>
              <input type="text" name class="f-input" placeholder="MM / YY" required>
            </div>
            <div class="col">
              <label class="f-label">CVV*</label>
              <input type="text" name="inputCVV" class="f-input" placeholder="***" required>
            </div>
          </div>
